    ...
    <div className="about">
      ...
      <div className="about_page">
        ...
        <div className="card-section">
          ...
          <AboutCard topic={'Our Leadership'} desc={"The association is governed by a Board of Trustees (BOT) and an elected Executive Committee. The BOT offers strategic oversight and continuity, while the Executives handle day-to-day affairs and drive key initiatives. Together, they ensure transparent, accountable, and impactful leadership."}/>
          <AboutCard topic={'Our Membership'} desc={"Our members include licensed hotels, guest houses, motels, and lodges operating within Ado Odo Ota and its environs. We welcome all hospitality establishments that seek to align with industry standards and contribute to a safer, more professional hospitality environment."}/>
